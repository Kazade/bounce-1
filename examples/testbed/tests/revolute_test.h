...
public:
	...
	void Step()
	{
		...
		DrawString(b3Color_white, "M - Motor");
		DrawString(b3Color_white, "L - Limits");
		DrawString(b3Color_white, "S/K/D - Static/kinematic/dynamic body");
	}
