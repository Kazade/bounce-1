...
#ifndef B3_TRIANGLE_SPHERE_CONTACT_H
#define B3_TRIANGLE_SPHERE_CONTACT_H

#include <bounce/dynamics/contacts/convex_contact.h>

class b3TriangleAndSphereContact : public b3ConvexContact
{
public:
	...
	b3TriangleAndSphereContact(b3Fixture* fixtureA, b3Fixture* fixtureB);
	~b3TriangleAndSphereContact() { }
