...
#ifndef B3_HULL_SPHERE_CONTACT_H
#define B3_HULL_SPHERE_CONTACT_H

#include <bounce/dynamics/contacts/convex_contact.h>

class b3HullAndSphereContact : public b3ConvexContact
{
public:
	...
	b3HullAndSphereContact(b3Fixture* fixtureA, b3Fixture* fixtureB);
	~b3HullAndSphereContact() { }
