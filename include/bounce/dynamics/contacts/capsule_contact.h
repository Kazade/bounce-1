...
#ifndef B3_CAPSULE_CONTACT_H
#define B3_CAPSULE_CONTACT_H

#include <bounce/dynamics/contacts/convex_contact.h>

class b3CapsuleContact : public b3ConvexContact
{
public:
	...
	b3CapsuleContact(b3Fixture* fixtureA, b3Fixture* fixtureB);
	~b3CapsuleContact() { }
