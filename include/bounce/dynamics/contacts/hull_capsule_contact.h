...
#ifndef B3_HULL_CAPSULE_CONTACT_H
#define B3_HULL_CAPSULE_CONTACT_H

#include <bounce/dynamics/contacts/convex_contact.h>

class b3HullAndCapsuleContact : public b3ConvexContact
{
public:
	...
	b3HullAndCapsuleContact(b3Fixture* fixtureA, b3Fixture* fixtureB);
